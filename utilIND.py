...
def license_complies_format(text):
    ...
    """
    if(len(text)==7):
        if (text[1] in string.ascii_uppercase or text[1] in dict_int_to_char.keys()) and \
...
def format_license(text):
    ...
    license_plate_ = ''
    if len(text)==7:
        mapping = {1: dict_int_to_char, 6: dict_int_to_char,
        ...
        mapping = {0: dict_int_to_char, 5: dict_int_to_char,
